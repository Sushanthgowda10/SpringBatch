...
public class Batchconfig {
	...
	public FlatFileItemReader<Employee> createFFIReader() {
		return new FlatFileItemReaderBuilder<Employee>().name("file-reader")
				.resource(new ClassPathResource("Employee_Info_.csv")).delimited()
				.names("eno", "ename", "eadd", "salary", "gender").targetType(Employee.class).build();
	}
	...
	public JdbcBatchItemWriter<Employee> createJBIWrier() {
		JdbcBatchItemWriter<Employee> writer = new JdbcBatchItemWriter<Employee>() {
			{
				setDataSource(ds);
				setSql("INSERT INTO employeeinfo VALUES(:eno,:ename,:eadd,:salary,:gender,:grosssalary,:netsalary)");
...
// writer.setSql("INSERT INTO employeeinfo
// VALUES(:eno,:ename,:eadd,:salary,:gender,:grosssalary,:netsalary)");
